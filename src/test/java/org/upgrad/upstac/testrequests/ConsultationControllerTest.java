...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status(){
        ...
        TestRequest testRequest2 = consultationController.assignForConsultation(testRequest1.getRequestId());
        ...
        assertThat("Comparing request id", testRequest.getRequestId() == testRequest2.getRequestId());
        assertThat("Comparing Status", testRequest2.getStatus() == RequestStatus.DIAGNOSIS_IN_PROCESS);

        assertNotNull(testRequest2.getConsultation());
    }
    ...
    public void calling_updateConsultation_with_valid_test_request_id_should_update_the_request_status_and_update_consultation_details(){
        ...
        assertThat("Compare Request ID's", testRequest.getRequestId() == testRequest1.getRequestId());
        assertThat("Check Status", testRequest1.getStatus() == RequestStatus.COMPLETED);
        assertThat("Check Suggestion", testRequest.getConsultation().getSuggestion() == testRequest1.getConsultation().getSuggestion());
